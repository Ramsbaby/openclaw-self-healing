...
**품질 체크 박스는 Discord/Telegram에 절대 보여주지 말 것!**

**규칙:**
- ❌ **박스 전체 출력 금지** — 본문보다 품질 체크가 길면 본말전도
- ❌ **"담는 중...", "끝" 같은 과정 언급 금지**
- ✅ **`memory/quality-check-YYYY-MM-DD.md` 파일에만 조용히 기록**
- ✅ **예외 없음** — 심각한 문제 발견해도 파일에만

**왜:**
- 정우님은 실제 결과만 보고 싶어하심
- 자기평가는 내부 개선용, 외부 노출 아님
- 본문 5줄 + 품질 체크 20줄 = 신뢰도 하락
